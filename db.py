...
def add_appointment(client_name, service_type, pest_type, address, zone, phone, date, time, price, status, notes):
    ...
    cur = conn.cursor()
    cur.execute("""
        INSERT INTO appointments (client_name, service_type, pest_type, address, zone, phone, date, time, price, status, notes)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (client_name, service_type, pest_type, address, zone, phone, date, time, price, status, notes))
    conn.commit()
    conn.close()
